...
\newcommand{\assignmentduedate}{April 12}
\newcommand{\assignmentassignedate}{April 8}
...
\begin{itemize}
  ...
  \item Web development concepts and Markdown, HTML, and CSS code (e.g., key
    definitions).
  ...
  \item Programming Markdown, HTML, and/or CSS statements in a web site, given a
    ...
    and CSS programming languages that do not currently exist. Given a source
...
\begin{itemize}
  ...
  \item The meaning of ``display resolution'' and its connection to the monitor
    size displaying a site

  \item An understanding of the file formats and extensions used to store images
    used on a web site
...
\begin{itemize}
  ...
  \item Understanding of the term ``viewport width'' and why it is critical in
    web development
