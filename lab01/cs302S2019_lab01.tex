...
and the output that your web page must produce. Now you are ready to download
the starting materials to your laboratory computer. Click the ``Clone or
download'' button and, after ensuring that you have selected ``Clone with SSH'',
please copy this command to your clipboard. To enter into your course directory
you should now type \command{cd cs302S2019}. Now, by typing \command{git clone}
in your terminal and then pasting in the string that you copied from the GitHub
...
What do you think is their purpose? What directory will function as the ``root''
of the web server for this assignment? Please note that this assignment includes
...
code. Alternatively, if you would like to use the keyboard to save your file,
...
\item A properly formatted and correct version of \mainprogramsource{} that both
  ...
  the desired static web site. Make sure that you know how to style the
  generated HTML using the two provided CSS files.
...
the whether or not it was submitted in a timely fashion and if your web page
