...
``Allegheny-Computer-Science-103-Spring-2019/computer-science-103-spring-2019-lab-3-gkapfham''.
...
should now type \command{cd cs103S2019}. Now, by typing \command{git clone} in
...
\begin{lstlisting}
  git clone git@github.com:Allegheny-Computer-Science-103-S2019/computer-science-103-spring-2019-lab-3-gkapfham.git
\end{lstlisting}
