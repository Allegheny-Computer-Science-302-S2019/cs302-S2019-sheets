...
repository for a screenshot that shows what your web site could look like when
completed. To finish this assignment, you should first find an image on Flickr
...
should contain at least two reviews of the photograph. You can read the
\program{TODO} markers in the provide file to learn more about the source code
that you must write. Students should check the correctness of their HTML by
running the command \command{htmlhint src/www/travels.html} in their terminal
window.
...
have to use the \gitadd{} command. Please see the course instructor if you have
...
\item Stored in \reflection{}, a one-paragraph reflection on the commands that
  ...
  full-featured response to each of the questions in this Markdown file.
...
addition to studying the efficiency and effectiveness of your HTML, the
