...
\newcommand{\assignmentassignedate}{February 11}
...
the``travel photographs'' example in Figure 3.9 of the textbook. You will
extend a travel web site so that it has more advanced features such as the use
...
through 3 in the course textbook, paying close attention to Section 3.5, Figure
3.9 and 3.16, and Table 3.1. Please see the course instructor or a teaching
...
\begin{lstlisting}
  git clone git@github.com:Allegheny-Computer-Science-302-S2019/computer-science-302-spring-2019-lab-3-gkapfham.git
\end{lstlisting}
...
\begin{figure}[t]
  ...
  \begin{verbatim}
    <blockquote>
      <p><b>By Ricardo on <time>February 8, 2019</time></b></p>
...
together to format the text and enable the display of an emoji in the five
...
\begin{figure}[t]
  ...
  127.0.0.1 - - [11/Feb/2019 10:48:10] "GET / HTTP/1.1" 200 - 0.0021
  127.0.0.1 - - [11/Feb/2019 10:48:11] "GET /css/github.css HTTP/1.1" 200 11629 0.0006
  127.0.0.1 - - [11/Feb/2019 10:48:11] "GET /css/emoji.css HTTP/1.1" 200 390578 0.0012
  127.0.0.1 - - [11/Feb/2019 10:48:11] "GET /img/plane.jpg HTTP/1.1" 200 22125 0.0005
  \end{verbatim}
  \vspace*{-.35in}
...
%
If you notice that transferring your files to GitHub did not work, then please
read the terminal messages and try to determine why.
%
