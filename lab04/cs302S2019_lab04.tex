...
\newcommand{\assignmentduedate}{February 25}
\newcommand{\assignmentassignedate}{February 18}
...
``Allegheny-Computer-Science-302-Spring-2019/computer-science-302-spring-2019-lab-4-gkapfham''.
...
\begin{lstlisting}
  git clone git@github.com:Allegheny-Computer-Science-302-S2019/computer-science-302-spring-2019-lab-4-gkapfham.git
\end{lstlisting}
...
reviews.
%
GatorGrader will also ensure that you have removed all of the \program{TODO}
markers from the provide source code files.
...
\begin{figure}[t]
  ...
  \begin{verbatim}
    ...
    127.0.0.1 - - [22/Feb/2019 11:46:22] "GET / HTTP/1.1" 200 - 0.0020
    127.0.0.1 - - [22/Feb/2019 11:46:22] "GET /css/site.css HTTP/1.1" 304 - 0.0004
    127.0.0.1 - - [22/Feb/2019 11:46:22] "GET /css/emoji.css HTTP/1.1" 304 - 0.0003
    127.0.0.1 - - [22/Feb/2019 11:46:22] "GET /img/plane.jpg HTTP/1.1" 304 - 0.0006
  \end{verbatim}
  \vspace*{-.35in}
...
\item Stored in \reflection{}, a one-paragraph answer to all of the stated
  ...
  solution for it. As requested, please make sure that you use inline source
  code segments to support your responses.
