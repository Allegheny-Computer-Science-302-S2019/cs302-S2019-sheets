...
well on this assignment, you should also review Chapters 1 through 7 in the
course textbook, further studying the content on web layout in Sections 7.1
through 7.8 and Listing 7.4. Although you are not required to create an example
in the textbook, students can develop ideas for their project by studying the
examples in Figure 7.42 on pages 316 and 317 and Figure 7.48 of Section 7.9.3.
Please see the instructor or a teaching assistant if you have questions about
...
\item Stored in \reflection{}, a one-paragraph answer to all of the stated
  questions. Please ensure that this Markdown file contains two fenced code
  blocks --- one containing HTML source code and one with CSS source code ---
  that you explain in a separate paragraph. Additionally, for every challenge
