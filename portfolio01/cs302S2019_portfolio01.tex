...
perspectives and technologies. The goal for this project is for you to learn
...
%
Ultimately, you will create a fully documented web site explores a stated theme
and is both publicly visible and mobile-ready.
%
Students are also invited to share the details about the design, implementation,
...
own web server and view the web site.
%
In addition to writing the aforementioned final report in Markdown, you will
also use Markdown to write and submit a project proposal and a status update at
