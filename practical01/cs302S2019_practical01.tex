...
\usepackage{listings} \lstset{ basicstyle=\small\ttfamily, columns=flexible,
breaklines=true }
...
\fancyhf{} \rhead{Computer Science 302} \lhead{Practical Assignment
\assignmentnumber{}} \rfoot{Page \thepage} \lfoot{\duedate}

\usepackage{titlesec} \titlespacing\section{0pt}{6pt plus 4pt minus 2pt}{4pt
plus 2pt minus 2pt}
...
% Please see the
% instructor or a teaching assistant if you are stuck on this step!
...
evaluation of this practical assignment. Finally, in adherence to the Honor
Code, students should complete this assignment on an individual basis.
