...
assignment. In addition to studying the output of programs like
\command{pandoc}, the instructor will also evaluate the accuracy of both your
writing and the constructs in your Markdown source code. If your submission
