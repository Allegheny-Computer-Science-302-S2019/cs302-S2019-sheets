...
programs such as a ``terminal window'' and a ``text editor''. You will also
...
``Allegheny-Computer-Science-302-Spring-2019/computer-science-302-spring-2019-practical-3-gkapfham''.
...
copy this command to your clipboard. To enter your course directory you should
now type \command{cd cs302S2019}. Next, you can type the command \command{ls}
and see that there are files or directories inside of this directory. By typing
...
\begin{lstlisting}
  git clone git@github.com:Allegheny-Computer-Science-302-S2019/computer-science-302-spring-2019-practical-3-gkapfham.git
\end{lstlisting}
...
\section*{Creating Ordered and Unordered Lists of Links in HTML}
...
some prior course assignments. Now, you are ready to create the lists that will
link to the \program{about.html} and \program{software.html} files.
...
created with the \command{<ul>} code. GatorGrader will also check to ensure that
\mainprogram{} passes all of the linting checks, does not have any
\program{TODO} markers inside of it, and uses the correct source code to open
