...
``Allegheny-Computer-Science-302-Spring-2019/computer-science-302-spring-2019-practical-4-gkapfham''.
...
\begin{lstlisting}
  git clone git@github.com:Allegheny-Computer-Science-302-S2019/computer-science-302-spring-2019-practical-4-gkapfham.git
\end{lstlisting}
...
\begin{figure}[t]
  ...
  \begin{verbatim}
    body {
      ...
      font-size: 16px;
      line-height: 1.6;
      [ NOTE: several lines deleted to save space ]
    }
  \end{verbatim}
  \vspace*{-3em}
  \caption{A Segment of Correct CSS Source Code that Styles the Parts of the HTML File.}~\label{fig:correct}
  \vspace*{-1em}
\end{figure}
...
\begin{figure}[t]
  ...
  <head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Montserrat|Roboto+Slab"
          rel="stylesheet" type="text/css">
  </head>
  \end{verbatim}
  \vspace*{-3em}
  \caption{A Segment of Correct HTML Source Code that References the CSS file.}~\label{fig:correcthtml}
  \vspace*{-2em}
\end{figure}
...
addition to studying the efficiency and effectiveness of your Markdown and/or HTML
source code, the instructor will also evaluate the accuracy of both your writing
and the constructs in your source code. If your submission receives a red
...
Finally, in adherence to Allegheny College's Honor Code, students should
complete this assignment on an individual basis. Deliverables (e.g., HTML source
code or Markdown-based technical writing) that are nearly identical to the work
of others will be taken as evidence of violating the \mbox{Honor Code}. Please
see the course instructor if you have questions about this policy.
