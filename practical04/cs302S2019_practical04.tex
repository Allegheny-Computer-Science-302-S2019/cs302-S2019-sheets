...
\begin{figure}[t]
  ...
  \end{verbatim}
  \vspace*{-3em}
  \caption{A Segment of Correct HTML Source Code that References the CSS and Fonts.}~\label{fig:correcthtml}
  \vspace*{-2em}
\end{figure}
...
Figures~\ref{fig:correct} and~\ref{fig:correcthtml} furnish examples of some of
the CSS and HTML source code that will style your web page to use the correct
fonts. Now, you should modify the provided CSS file so that it specifies
\command{border-width: 1pt 1pt 1pt 1pt;} and \command{padding: 10px 10px 10px
20px;} for the styling of the \program{<blockquote>}. This should create a thin
border on all sides of the part of your site that includes your professional
biography. Finally, don't forget to use the \command{<footer>} tag to add at
least two emoji and your name to the bottom of the web site. You should also use
CSS code to style your \command{<footer>} so that it contains a thin border on
all of its sides.
