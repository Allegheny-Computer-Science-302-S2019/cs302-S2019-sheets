...
\newcommand{\thirdprogram}{\lstinline{fontchange.js}}
\newcommand{\thirdprogramsource}{\lstinline{src/www/js/fontchange.js}}
...
well on this assignment, you should also review Chapters 9 and 10 in the course
textbook, focusing on the content about event-driven programming and the use of
asynchronous JavaScript and XML (AJAX). assignment the students are responsible
for finding and reading all of the auxiliary materials that they need to
successfully design the requested web site. Please see the course instructor or
a teaching assistant if you have questions about these reading assignments.
...
``Allegheny-Computer-Science-302-Spring-2019/computer-science-302-spring-2019-practical-8-gkapfham''.
...
\begin{lstlisting}
  git clone git@github.com:Allegheny-Computer-Science-302-S2019/computer-science-302-spring-2019-practical-8-gkapfham.git
\end{lstlisting}
...
furnishes HTML, CSS, and JavaScript files with starting content. Spend some time
exploring these files, sharing your discoveries with the \mbox{course
instructor}. You should draw a diagram that explains how these files connect to
each other.

\section*{Dynamic Font Loading and Use with JavaScript}

This practical assignment invites you to learn how to use JavaScript to
...
study the provided source code and the technical diagram that you created at an
earlier stage in this practical session, you should notice that the source code
is implemented so that it should work regardless of the chosen web fonts. As
such, please modify the provided code so that it works with four new Google web
fonts. Don't forget to test your program, ensuring that you use the following
source code, in your HTML file, to load the needed JavaScript files.
...
output suggesting that it is returning the correct files. If not, then please
make sure that you revise your source code and/or server configuration. Finally,
when you are studying your web site you should verify that the font should
dynamically load when you click on each of the individual buttons.
...
tags and does not have any \program{TODO} markers to indicate unfinished work.
...
\item A properly formatted and correct version of \thirdprogramsource{} that
  both meets all of the established requirements and contains the JavaScript
  that applies web fonts.
...
\item Stored in \screenshot{}, a PNG image that give the screenshot of the final
  ...
  feature to produce this image. Alternatively, you can create the screenshot
